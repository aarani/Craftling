...
func NewAdminHandler(users *repository.UserRepository, servers *repository.GameServerRepository) *AdminHandler {
	return &AdminHandler{users: users, servers: servers}
}
