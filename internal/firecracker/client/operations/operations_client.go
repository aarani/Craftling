...
type ClientService interface {
	...
	PatchGuestPmemByID(params *PatchGuestPmemByIDParams, opts ...ClientOption) (*PatchGuestPmemByIDNoContent, error)
	...
	StartBalloonHinting(params *StartBalloonHintingParams, opts ...ClientOption) (*StartBalloonHintingNoContent, error)

	StopBalloonHinting(params *StopBalloonHintingParams, opts ...ClientOption) (*StopBalloonHintingNoContent, error)
...
*/
func (a *Client) PatchGuestPmemByID(params *PatchGuestPmemByIDParams, opts ...ClientOption) (*PatchGuestPmemByIDNoContent, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewPatchGuestPmemByIDParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "patchGuestPmemByID",
		Method:             "PATCH",
		PathPattern:        "/pmem/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &PatchGuestPmemByIDReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	// only one success response has to be checked
	success, ok := result.(*PatchGuestPmemByIDNoContent)
	if ok {
		return success, nil
	}
	...
	//
	// a default response is provided: fill this and return an error
	unexpectedSuccess := result.(*PatchGuestPmemByIDDefault)
...
*/
func (a *Client) StartBalloonHinting(params *StartBalloonHintingParams, opts ...ClientOption) (*StartBalloonHintingNoContent, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
	...
	// only one success response has to be checked
	success, ok := result.(*StartBalloonHintingNoContent)
	if ok {
		return success, nil
	}
...
*/
func (a *Client) StopBalloonHinting(params *StopBalloonHintingParams, opts ...ClientOption) (*StopBalloonHintingNoContent, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
	...
	// only one success response has to be checked
	success, ok := result.(*StopBalloonHintingNoContent)
	if ok {
		return success, nil
	}
